// jhcEliRWI.h : basic runtime loop with post-processed sensors and high level commands
//
...
class jhcEliRWI : public jhcBackgRWI, private jhcDraw
{
// PRIVATE MEMBER VARIABLES
private:
  jhcImg limb, mark, mark2;
  UL32 tnow;
  int phy, seen, reflex, batt, sprc;
