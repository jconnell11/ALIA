...
int main (int argc, char *argv[])
{
  ...
  // make output images for display
  view.SetSize(640, 480, 3);
  map.SetSize(alia_wmap(), alia_hmap(), 3);        

  // make up simple image display panels
  ocv_win(0, "View");
  ocv_win(1, "Map");
  ...
  while (1)
  {
    ...
    // show results of thought cycle
    ocv_queue(0, (UC8 *) alia_view, view.XDim(), view.YDim());
    ocv_queue(1, (UC8 *) alia_map, map.XDim(), map.YDim());
    ocv_show(); 
