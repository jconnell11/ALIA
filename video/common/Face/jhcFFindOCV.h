...
// implements functions found in "ffind_ocv.h"
...
private:
  ...
  int cok;               /** Cascade properly configured. */
  int nface;             /** Number of faces found.       */


// PUBLIC MEMBER VARIABLES
public:
  // module handle for DLL or EXE (0) -- Windows only
  void *hmod;
...
public:
  ...
  int FindReady () const {return cok;}
...
public:
  ...
  int extract_xml (const char *fname) const;
